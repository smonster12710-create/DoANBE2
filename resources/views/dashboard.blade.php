                        ...
                        <div class="menu-item">
                            <a class="danh_muc" data-bs-toggle="modal" data-bs-target="#createPostModal">
                                <svg style="width: 30px; height: 30px;" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="menu-item">
                                    {{-- Gắn link Route vào thẻ a --}}
                                    <a href="{{ route('notifications.index') }}" class="danh_muc d-flex align-items-center"
                                        style="text-decoration: none; color: inherit;">
                                    
                                        {{-- Bọc SVG trong position-relative để gắn cái chấm đỏ đè lên --}}
                                        <div class="position-relative me-2">
                                            ...
                                            {{-- Đếm thông báo chưa đọc trực tiếp --}}
                                            @php
$unread = auth()->check() ? \App\Models\Notification::where('user_id', auth()->id())->where('is_read', 0)->count() : 0;
                                            @endphp
                                    
                                            {{-- Nếu có thông báo mới thì hiện chấm đỏ --}}
                                            @if($unread > 0)

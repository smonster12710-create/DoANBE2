                                ...
                                @else
                                        ...
                                        @if (auth()->check() && auth()->id() !== $post->user_id)
                                            <form action="{{ route('follow.toggle', $post->user_id) }}" method="POST" class="ms-5 m-0">
                                                ...
                                                @endphp
                                                <button type="submit" class="btn p-0 border-0 fw-bold {{ $isFollowing ? 'btn-following' : 'btn-follow' }}"
                                    ...
                                    @if (auth()->id() == $post->user_id)
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editPostModal{{ $post->id }}">Sửa bài
                                                        viết</button></li>

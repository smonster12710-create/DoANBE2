    ...
    <div class="edit-profile-page">
        <div class="edit-profile-container">
            ...
            <div class="edit-header">
                ...
                <div class="edit-card">
                    <h2>Quyền riêng tư & ẩn danh</h2>

                    <div class="form-group">
                        <label style="display: flex; align-items: center; gap: 10px;">
                            <input type="checkbox" name="anonymous_posts" value="1" {{ $user->anonymous_posts ? 'checked' : '' }}>
                            <span>Bật ẩn danh khi đăng bài</span>
                        </label>
                        <p style="margin: 8px 0 0; color: #6c757d; font-size: 14px; line-height: 1.4;">
                            Khi bật, mọi bài viết mới của bạn sẽ được đăng dưới tên Ẩn danh và dùng ảnh đại diện mặc định.
                        </p>
                    </div>
                </div>

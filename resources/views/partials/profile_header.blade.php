<div class="profile-card">
    ...
    <div class="profile-info">
        ...
        <div class="profile-action-buttons">
            ...
            <form method="POST" action="{{ route('friend.remove', $user->username) }}" class="friend-action-form">
                @csrf
            ...
            <div class="requested-actions">
                <form method="POST" action="{{ route('friend.accept', $user->username) }}" class="friend-action-form">
                    @csrf
            ...
            @else
            <form method="POST" action="{{ route('friend.send', $user->username) }}" class="friend-action-form">
                @csrf
